...
if (stunTime > 0) {
	...
	if (twoPressed) {
		...
		if (true/*abilityState == NONE*/) {
			...
			if (fireShotReady) {
				instance_create(preciseX, preciseY, objFireCircleTP);
				fireShotReady = false;
				alarm[FIRE_SHOT_CD] = fireShotCDTime;
			}
		}
