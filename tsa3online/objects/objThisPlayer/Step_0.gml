...
if (connectedToServer && instance_exists(tpId)) {
	...
	if (room == rmCharacterSelect) {
		...
		buffer_write(bufferToSend, buffer_bool, tpId.abilityState == NONE);
	} else {
