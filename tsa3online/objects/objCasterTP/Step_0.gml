...
if (aState == "1") {
	...
	if (aPhase == "d") {
		if (timeInAPhase >= 0 && firstTime[3]) {
			...
			ballId = instance_create_depth(preciseX, preciseY, thisNumber, objIceBall)
			firstTime[3] = false;
		}
	}
}
