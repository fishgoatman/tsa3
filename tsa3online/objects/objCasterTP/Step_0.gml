...
if (aState == "1") {
	...
	if (aPhase == "u") {
		if (timeInAPhase == 0) {
			pillarXScale = image_xscale;
		}
	} else if (aPhase == "d") {
		if (timeInAPhase == 0) {
			instance_create_depth(preciseX + slowOffset * pillarXScale, room_height, thisNumber, objIceSlow);
		}
	}
}
