...
/// @DnDVersion : 1
/// @DnDHash : 52936405
/// @DnDArgument : "code" "///@desc settings$(13_10)globalvar hpBarWidth, hpPerLine, hpBarOffset, hpBarHeight, $(13_10)		cooldownOffset, rightControlMode, numPlayers, $(13_10)		selectedHero, lockedIn, heroId, hpBar, playerHandlerObj, $(13_10)		cooldownBar, startGameDelay, characterSelect, challengerSelect,$(13_10)		selectBoxes, mapSelect, mapSelectBoxes, auto, numberWithSprite2,$(13_10)		mapLockedIn, urf;$(13_10)$(13_10)rightControlMode = "keyboard";$(13_10)room_speed = 60;$(13_10)jumpGrace = 0.1 * room_speed;$(13_10)hpBarWidth = 150;$(13_10)hpPerLine = 12;$(13_10)hpBarOffset = 50;$(13_10)hpBarHeight = 55;$(13_10)cooldownOffset = 20;$(13_10)backButtonOffset = 15$(13_10)exitButtonOffset = 10$(13_10)helpBorderWidth = 50$(13_10)numPlayers = 2;$(13_10)startGameDelay = 0.75 * room_speed;$(13_10)characterSelect[0, 0] = "mage"$(13_10)characterSelect[0, 1] = "caster"$(13_10)characterSelect[1, 0] = "rogue"$(13_10)characterSelect[1, 1] = "monk"$(13_10)challengerSelect[0, 0] = "monkMage"$(13_10)challengerSelect[0, 1] = "caster"$(13_10)challengerSelect[1, 0] = "rogue"$(13_10)challengerSelect[1, 1] = "monk"$(13_10)selectBoxes[0, 0] = objMageSelection$(13_10)selectBoxes[0, 1] = objCasterSelection$(13_10)selectBoxes[1, 0] = objRogueSelection$(13_10)selectBoxes[1, 1] = objMonkSelection$(13_10)mapSelect[0, 0] = rmDesert$(13_10)mapSelect[0, 1] = rmTundra$(13_10)mapSelect[1, 0] = rmMountain$(13_10)mapSelect[1, 1] = rmForest$(13_10)mapSelectBoxes[0, 0] = objDesertSelection$(13_10)mapSelectBoxes[0, 1] = objTundraSelection$(13_10)mapSelectBoxes[1, 0] = objMountainSelection$(13_10)mapSelectBoxes[1, 1] = objForestSelection$(13_10)mapLockedIn = false$(13_10)debug = true$(13_10)auto = false$(13_10)urf = false$(13_10)bkMusics[0] = sndLoveDream$(13_10)bkMusics[1] = sndGymno1$(13_10)bkMusics[2] = sndClairDeLune$(13_10)lobbyMusic = sndGymno1$(13_10)$(13_10)///depths$(13_10)globalvar uiDepth;$(13_10)uiDepth = 2"
///@desc settings
globalvar hpBarWidth, hpPerLine, hpBarOffset, hpBarHeight, 
		...
		cooldownBar, startGameDelay, characterSelect, challengerSelect,
		selectBoxes, mapSelect, mapSelectBoxes, auto, numberWithSprite2,
		mapLockedIn, urf;
...
challengerSelect[0, 0] = "monkMage"
challengerSelect[0, 1] = "caster"
challengerSelect[1, 0] = "rogue"
challengerSelect[1, 1] = "monk"
...
lastEpochSec = floor(date_second_span(date_create_datetime(1970,1,1,0,0,0),date_current_datetime()))
globalvar thisInControl, playerMode, leftControls, rightControls, numKeys, aiHalfCooldown;
