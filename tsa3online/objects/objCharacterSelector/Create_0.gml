...
if (room == rmChallengerCharacterSelect) {
	selectArray = challengerSelect
} else {
	selectArray = characterSelect
}

currRow = 0;
currCol = 0;
numRows = array_height_2d(selectArray);
...
if (room == rmCharacterSelect) {
	...
	sprite_index = sprMapSelection
} else if (room == rmAICharacterSelect) {
	sprite_index = sprAISelection
}
